...
const MeIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>;
...
export const NAV_ITEMS: { view: View; label: string; icon: React.ReactNode }[] = [
  ...
  { view: 'Study', label: 'Study', icon: <StudyIcon /> },
  { view: 'Writing', label: 'Writing', icon: <WritingIcon /> },
  { view: 'Books', label: 'Books', icon: <BookIcon /> },
  { view: 'Learn', label: 'Learn', icon: <LearnIcon /> },
  { view: 'Pomodoro', label: 'Pomodoro', icon: <TimerIcon /> },
  { view: 'Journal', label: 'Journal', icon: <JournalIcon /> },
  { view: 'Me', label: 'Me', icon: <MeIcon /> },
  { view: 'Music', label: 'Music', icon: <MusicIcon /> },
];

export const VIEWS: View[] = ['Dashboard', 'Study', 'Writing', 'Books', 'Learn', 'Pomodoro', 'Journal', 'Me', 'Music'];